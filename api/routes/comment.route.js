...
import { createComment,getComment,likeComment,editComment,deleteComment,getDashComment } from '../controllers/comment.controller.js';
...
router.get('/getDashComment', getDashComment);
